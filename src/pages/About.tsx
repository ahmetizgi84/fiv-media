...
const About = () => {
  return (
    <div className="bg-[#1a1a1a]">
      ...
      {/* 2nd */}
      <div className="uppercase pb-0 py-[120px] relative">
      ...
      <section className="py-[120px] bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap">
            ...
            <div className="flex-auto w-[66.6%] px-[15px]">
              <div
            ...
            <div className="flex-auto w-[33.3%]">
              <div className="mt-[80px]">
                <h6 className="text-sm font-light uppercase tracking-widest">Our Story.</h6>
              </div>
            </div>
            <div className="flex-auto w-[66.6%]">
              <div className="mt-[80px] ">
                <h4 className="text-[28px] font-semibold leading-10">
