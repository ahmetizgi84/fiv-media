    ...
    <motion.section
      ...
      <div className="max-w-7xl mx-auto px-4">
        <motion.h1
          ...
          className="md:text-8xl text-[35px] font-bold tracking-[2px] md:leading-[7rem]">
...
function Benefits() {
  return (
    <motion.div
      ...
      <motion.section variants={cardVariants} className="max-w-7xl mx-auto px-4 md:flex pt-[120px]">
...
function Revenue() {
  return (
    <motion.div
      ...
      whileInView="onscreen"
      viewport={{ once: true, amount: 0.8 }}>
      <motion.section variants={cardVariants} className="max-w-7xl mx-auto px-4 md:flex py-[120px]">
...
function OurServices() {
  return (
    <motion.div
      ...
      whileInView="onscreen"
      viewport={{ once: true, amount: 0.8 }}>
      <motion.section variants={cardVariants} className="max-w-7xl mx-auto px-4">
...
function Services() {
  return (
    <motion.div
      ...
      whileInView="onscreen"
      viewport={{ once: true, amount: 0.8 }}>
      <motion.section variants={cardVariants} className="max-w-7xl mx-auto md:flex py-[120px]">
...
function PeopleSay() {
  return (
    <motion.div
      ...
      whileInView="onscreen"
      viewport={{ once: true, amount: 0.8 }}>
      <motion.section variants={cardVariants} className="py-[120px] md:flex mx-auto bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-4">
